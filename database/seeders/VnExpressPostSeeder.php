...
<article class="font-sans max-w-none text-base text-gray-800">
    ...
    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">3 trường hợp Nhà nước thu hồi đất mới</h2>
    ...
    <ul class="list-none space-y-2 mb-4">
        <li class="leading-relaxed">• <span class="font-semibold">Trường hợp 1:</span> Thu hồi đất để thực hiện dự án khu thương mại tự do hay trong trung tâm tài chính quốc tế.</li>
        <li class="leading-relaxed">• <span class="font-semibold">Trường hợp 2:</span> Chủ đầu tư đã đàm phán được trên 75% diện tích và hơn 75% người có đất. HĐND cấp tỉnh sẽ xem xét, thông qua việc thu hồi phần đất còn lại để giao cho chủ đầu tư.</li>
        <li class="leading-relaxed">• <span class="font-semibold">Trường hợp 3:</span> Nhà nước thu hồi để tạo quỹ đất thanh toán theo hợp đồng BT, cho thuê đất, tiếp tục sản xuất kinh doanh.</li>
    </ul>

    <div class="bg-teal-50 border-l-4 border-teal-400 p-4 my-4">
    ...
    <figure class="my-6">
        <img src="https://res.cloudinary.com/dsiier5sg/image/upload/v1765434103/dai-bieu-11-12-2025_lo9u1u.webp" alt="Phiên họp Quốc hội" class="w-full rounded-lg shadow-md" />
    ...
    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Quy định hiện hành về thu hồi đất</h2>
    ...
    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Bảng giá đất và bồi thường</h2>
    ...
    <div class="bg-gray-50 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-gray-900 mb-3">Quy trình xây dựng bảng giá đất:</h3>
        <ul class="list-none space-y-2 text-gray-700">
            <li class="flex items-start"><span class="text-teal-500 mr-2">✓</span><span>Xây dựng theo loại, vị trí và khu vực đất</span></li>
            <li class="flex items-start"><span class="text-teal-500 mr-2">✓</span><span>HĐND cấp tỉnh quyết định bảng giá</span></li>
            <li class="flex items-start"><span class="text-teal-500 mr-2">✓</span><span>Áp dụng từ 1/1/2026</span></li>
            <li class="flex items-start"><span class="text-teal-500 mr-2">✓</span><span>Sửa đổi, bổ sung khi cần thiết</span></li>
        </ul>
    </div>

    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Quy trình thông báo thu hồi đất</h2>

    <div class="overflow-x-auto my-4">
        <table class="min-w-full rounded-xl overflow-hidden shadow-sm">
            <thead class="bg-gradient-to-r from-teal-500 to-teal-600">
                <tr>
                    <th class="px-4 py-3 text-left font-semibold text-white">Loại đất</th>
                    <th class="px-4 py-3 text-left font-semibold text-white">Thời gian thông báo</th>
                </tr>
            </thead>
            <tbody>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Đất nông nghiệp</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold">Tối thiểu 60 ngày</td>
                </tr>
                <tr class="bg-teal-50/50 hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Đất phi nông nghiệp</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold">Tối thiểu 120 ngày</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-amber-800 mb-2">📋 Quy trình công khai và đối thoại:</h3>
...
HTML;
        ...
        $schemaJson = [
            ...
            'image' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434103/dai-bieu-11-12-2025_lo9u1u.webp',
        ...
        $postId = DB::table('posts')->insertGetId([
            ...
            'content' => $content,
            'content_fmt' => 'html',
            'cover_image_url' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434103/dai-bieu-11-12-2025_lo9u1u.webp',
            'reading_minutes' => 4,
            'locale' => 'vi',
            ...
            'og_image' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434103/dai-bieu-11-12-2025_lo9u1u.webp',
...
<article class="font-sans max-w-none text-base text-gray-800">
    ...
    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Dự án 1: Khu nhà ở xã hội Bamboo Garden</h2>

    <div class="bg-teal-50 border border-teal-200 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-teal-800 mb-2">🏠 Thông tin dự án Bamboo Garden</h3>
    ...
    <div class="overflow-x-auto my-4">
        <table class="min-w-full rounded-xl overflow-hidden shadow-sm">
            <thead class="bg-gradient-to-r from-teal-500 to-teal-600">
                <tr>
                    <th class="px-4 py-3 text-left font-semibold text-white">Thông tin</th>
                    <th class="px-4 py-3 text-left font-semibold text-white">Chi tiết</th>
                </tr>
            </thead>
            <tbody>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Số căn mở bán</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold">86 căn</td>
                </tr>
                <tr class="bg-teal-50/50 hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Diện tích</td>
                    <td class="px-4 py-3 border-b border-gray-100">48,6 - 58,6 m²</td>
                </tr>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Giá bán</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-bold text-teal-600">~10 triệu/m²</td>
                </tr>
                <tr class="bg-teal-50/50 hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Tổng giá</td>
                    <td class="px-4 py-3 border-b border-gray-100">486 - 586 triệu</td>
                </tr>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Nhận hồ sơ</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold text-rose-600">01/12 - 15/01/2026</td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <figure class="my-6">
        <img src="https://res.cloudinary.com/dsiier5sg/image/upload/v1765434396/khu-nha-o-boo-garden_jfnl5x.webp" alt="Khu nhà ở xã hội Bamboo Garden" class="w-full rounded-lg shadow-md" />
        <figcaption class="text-center text-gray-500 text-sm mt-2 italic">Khu nhà ở xã hội Bamboo Garden</figcaption>
    </figure>

    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Dự án 2: Khu nhà xã hội Đông Hội</h2>

    <div class="bg-sky-50 border border-sky-200 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-sky-800 mb-2">🏢 Thông tin dự án Đông Hội</h3>
    ...
    <div class="overflow-x-auto my-4">
        <table class="min-w-full rounded-xl overflow-hidden shadow-sm">
            ...
            <tbody>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Số căn mở bán</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold">88 căn</td>
                </tr>
                <tr class="bg-teal-50/50 hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Diện tích</td>
                    <td class="px-4 py-3 border-b border-gray-100">57,8 - 67,2 m²</td>
                </tr>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Giá bán</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-bold text-teal-600">~15 triệu/m²</td>
                </tr>
                <tr class="bg-teal-50/50 hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Tổng giá</td>
                    <td class="px-4 py-3 border-b border-gray-100">867 triệu - 1 tỷ+</td>
                </tr>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Nhận hồ sơ</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold text-rose-600">01/12 - 12/01/2026</td>
                </tr>
            </tbody>
        </table>
    </div>

    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Mục tiêu phát triển nhà ở xã hội</h2>
    ...
    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Xu hướng giá nhà ở xã hội</h2>

    <div class="bg-rose-50 border border-rose-200 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-rose-800 mb-2">📈 Biến động giá</h3>
...
HTML;
        ...
        $schemaJson = [
            ...
            'image' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434396/khu-nha-o-boo-garden_jfnl5x.webp',
        ...
        $postId = DB::table('posts')->insertGetId([
            ...
            'content' => $content,
            'content_fmt' => 'html',
            'cover_image_url' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434396/khu-nha-o-boo-garden_jfnl5x.webp',
            'reading_minutes' => 5,
            'locale' => 'vi',
            'published_at' => $publishedAt,
            'canonical_url' => 'https://phatdatbatdongsan.com/tin-tuc/' . $slug,
            ...
            'og_image' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434396/khu-nha-o-boo-garden_jfnl5x.webp',
            'twitter_card' => 'summary_large_image',
            'robots_index' => true,
            'robots_follow' => true,
            'robots_advanced' => null,
...
<article class="font-sans max-w-none text-base text-gray-800">
    ...
    <figure class="my-6">
        <img src="https://res.cloudinary.com/dsiier5sg/image/upload/v1765434396/bo-truong-xay-dung-tran-hong-minh_gnj7yd.webp" alt="Bộ trưởng Xây dựng Trần Hồng Minh" class="w-full rounded-lg shadow-md" />
        <figcaption class="text-center text-gray-500 text-sm mt-2 italic">Bộ trưởng Xây dựng Trần Hồng Minh phát biểu tại phiên họp chiều 10/12</figcaption>
    </figure>

    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">So sánh thời gian cấp phép</h2>

    <div class="overflow-x-auto my-4">
        <table class="min-w-full rounded-xl overflow-hidden shadow-sm">
            <thead class="bg-gradient-to-r from-teal-500 to-teal-600">
                <tr>
                    <th class="px-4 py-3 text-left font-semibold text-white">Loại công trình</th>
                    <th class="px-4 py-3 text-left font-semibold text-white">Hiện tại</th>
                    <th class="px-4 py-3 text-left font-semibold text-white">Dự kiến mới</th>
                </tr>
            </thead>
            <tbody>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Nhà ở riêng lẻ</td>
                    <td class="px-4 py-3 border-b border-gray-100">15 ngày</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-bold text-teal-600">7-10 ngày</td>
                </tr>
                <tr class="bg-teal-50/50 hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Công trình khác</td>
                    <td class="px-4 py-3 border-b border-gray-100">20 ngày</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-bold text-teal-600">7-10 ngày</td>
                </tr>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100">Công trình cấp I, II</td>
                    <td class="px-4 py-3 border-b border-gray-100">30 ngày</td>
                    <td class="px-4 py-3 border-b border-gray-100 font-bold text-teal-600">Giảm 30%</td>
                </tr>
            </tbody>
        </table>
    </div>

    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Những thay đổi quan trọng</h2>

    <div class="bg-sky-50 border border-sky-200 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-sky-800 mb-2">📋 Cải cách thủ tục</h3>
        <ul class="list-none space-y-2 text-sky-900">
            <li class="flex items-start"><span class="text-sky-500 mr-2">•</span><span>Bãi bỏ thủ tục thẩm định thiết kế kỹ thuật, bản vẽ thi công</span></li>
            <li class="flex items-start"><span class="text-sky-500 mr-2">•</span><span>Chủ đầu tư chịu trách nhiệm kiểm soát thiết kế sau khi được duyệt</span></li>
            <li class="flex items-start"><span class="text-sky-500 mr-2">•</span><span>Mỗi công trình chỉ thực hiện <strong>một thủ tục</strong> từ chuẩn bị đến khởi công</span></li>
            <li class="flex items-start"><span class="text-sky-500 mr-2">•</span><span>Tăng trách nhiệm tư vấn thiết kế về an toàn công trình</span></li>
        </ul>
    </div>

    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Công trình được miễn giấy phép</h2>

    <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-amber-800 mb-2">🏠 Các trường hợp miễn giấy phép xây dựng</h3>
        <ul class="list-none space-y-2 text-amber-900">
    ...
    <div class="bg-rose-50 border-l-4 border-rose-400 p-4 my-4">
    ...
    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Thời điểm có hiệu lực</h2>

    <div class="bg-gray-50 rounded-lg p-4 my-4">
        <ul class="list-none space-y-2 text-gray-700">
            <li class="flex items-start"><span class="text-teal-500 mr-2">✓</span><span><strong>Luật Xây dựng (sửa đổi):</strong> Có hiệu lực từ 1/7/2026</span></li>
            <li class="flex items-start"><span class="text-teal-500 mr-2">✓</span><span><strong>Quy định miễn giấy phép:</strong> Có hiệu lực từ đầu năm 2026</span></li>
        </ul>
    </div>
...
HTML;
        ...
        $schemaJson = [
            ...
            'image' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434396/bo-truong-xay-dung-tran-hong-minh_gnj7yd.webp',
        ...
        $postId = DB::table('posts')->insertGetId([
            ...
            'content' => $content,
            'content_fmt' => 'html',
            'cover_image_url' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434396/bo-truong-xay-dung-tran-hong-minh_gnj7yd.webp',
            'reading_minutes' => 4,
            'locale' => 'vi',
            'published_at' => $publishedAt,
            'canonical_url' => 'https://phatdatbatdongsan.com/tin-tuc/' . $slug,
            ...
            'og_image' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434396/bo-truong-xay-dung-tran-hong-minh_gnj7yd.webp',
            'twitter_card' => 'summary_large_image',
            'robots_index' => true,
            'robots_follow' => true,
            'robots_advanced' => null,
...
<article class="font-sans max-w-none text-base text-gray-800">
    ...
    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Công nghiệp phát triển, đô thị hóa nhanh</h2>
    ...
    <div class="bg-sky-50 border border-sky-200 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-sky-800 mb-2">🏭 Thống kê khu công nghiệp</h3>
        <ul class="list-none space-y-2 text-sky-900">
    ...
    <figure class="my-6">
        <img src="https://res.cloudinary.com/dsiier5sg/image/upload/v1765434253/khu-cong-nghiep-nhon-trach-2_vpmea0.webp" alt="Khu công nghiệp Nhơn Trạch" class="w-full rounded-lg shadow-md" />
        <figcaption class="text-center text-gray-500 text-sm mt-2 italic">Khu công nghiệp Nhơn Trạch II - Nhơn Phú</figcaption>
    </figure>

    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Tập trung nhiều cảng biển, trung tâm logistics</h2>
    ...
    <div class="bg-teal-50 border border-teal-200 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-teal-800 mb-2">🚢 Hệ thống cảng và logistics</h3>
        <ul class="list-none space-y-2 text-teal-900">
    ...
    <figure class="my-6">
        <img src="https://res.cloudinary.com/dsiier5sg/image/upload/v1765434254/ben-cang-cai-mep_wpqumi.webp" alt="Bến cảng Cái Mép" class="w-full rounded-lg shadow-md" />
        <figcaption class="text-center text-gray-500 text-sm mt-2 italic">Bến cảng Cái Mép - cảng trọng điểm phía Nam</figcaption>
    </figure>
    ...
    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Hạ tầng giao thông kết nối</h2>

    <div class="overflow-x-auto my-4">
        <table class="min-w-full rounded-xl overflow-hidden shadow-sm">
            <thead class="bg-gradient-to-r from-teal-500 to-teal-600">
                <tr>
                    <th class="px-4 py-3 text-left font-semibold text-white">Dự án hạ tầng</th>
                    <th class="px-4 py-3 text-left font-semibold text-white">Chi tiết</th>
                </tr>
            </thead>
            <tbody>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold">Đường 319</td>
                    <td class="px-4 py-3 border-b border-gray-100">Nối vào cao tốc TP HCM - Long Thành</td>
                </tr>
                <tr class="bg-teal-50/50 hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold">Đường Nguyễn Văn Ký</td>
                    <td class="px-4 py-3 border-b border-gray-100">Mở rộng lên 30m, trục chính đô thị</td>
                </tr>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold">Vành đai 3</td>
                    <td class="px-4 py-3 border-b border-gray-100">Đoạn Nhơn Trạch - TP HCM dài 30km</td>
                </tr>
                <tr class="bg-teal-50/50 hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold">Cao tốc Bến Lức - Long Thành</td>
                    <td class="px-4 py-3 border-b border-gray-100">Hòa vào hệ thống cao tốc Bắc - Nam</td>
                </tr>
                <tr class="bg-white hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold">Metro số 1</td>
                    <td class="px-4 py-3 border-b border-gray-100">Kéo dài tuyến Suối Tiên - Đồng Nai</td>
                </tr>
                <tr class="bg-teal-50/50 hover:bg-teal-50 transition-colors">
                    <td class="px-4 py-3 border-b border-gray-100 font-semibold">Cầu Cát Lái</td>
                    <td class="px-4 py-3 border-b border-gray-100">Kết nối xã Phú Hữu với Quận 2</td>
                </tr>
            </tbody>
        </table>
    </div>

    <h2 class="text-xl font-bold text-gray-900 mt-6 mb-3">Thị trường bất động sản sôi động</h2>
    ...
    <div class="bg-gray-50 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-gray-900 mb-3">🏘️ Các dự án đô thị nổi bật</h3>
        <div class="flex flex-wrap gap-2">
            <span class="bg-white px-3 py-1 rounded-full text-sm text-gray-700 border border-gray-200">Thang Long Home Hiệp Phước</span>
            <span class="bg-white px-3 py-1 rounded-full text-sm text-gray-700 border border-gray-200">Mega City</span>
            <span class="bg-white px-3 py-1 rounded-full text-sm text-gray-700 border border-gray-200">King Bay</span>
            <span class="bg-white px-3 py-1 rounded-full text-sm text-gray-700 border border-gray-200">Swan Bay</span>
            <span class="bg-white px-3 py-1 rounded-full text-sm text-gray-700 border border-gray-200">Swan Park</span>
            <span class="bg-white px-3 py-1 rounded-full text-sm text-gray-700 border border-gray-200">Aqua City</span>
            <span class="bg-white px-3 py-1 rounded-full text-sm text-gray-700 border border-gray-200">Tiến Lộc Garden</span>
        </div>
    </div>

    <figure class="my-6">
        <img src="https://res.cloudinary.com/dsiier5sg/image/upload/v1765434252/phoi-canh-tien-loc-garden_aie91c.webp" alt="Phối cảnh Tiến Lộc Garden" class="w-full rounded-lg shadow-md" />
        <figcaption class="text-center text-gray-500 text-sm mt-2 italic">Phối cảnh dự án Tiến Lộc Garden tại Nhơn Trạch</figcaption>
    </figure>

    <div class="bg-rose-50 border border-rose-200 rounded-lg p-4 my-4">
        <h3 class="font-semibold text-rose-800 mb-2">💰 Mức giá tham khảo</h3>
...
HTML;
        ...
        $schemaJson = [
            ...
            'image' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434252/phoi-canh-tien-loc-garden_aie91c.webp',
        ...
        $postId = DB::table('posts')->insertGetId([
            ...
            'content' => $content,
            'content_fmt' => 'html',
            'cover_image_url' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434252/phoi-canh-tien-loc-garden_aie91c.webp',
            'reading_minutes' => 5,
            'locale' => 'vi',
            'published_at' => $publishedAt,
            'canonical_url' => 'https://phatdatbatdongsan.com/tin-tuc/' . $slug,
            ...
            'og_image' => 'https://res.cloudinary.com/dsiier5sg/image/upload/v1765434252/phoi-canh-tien-loc-garden_aie91c.webp',
            'twitter_card' => 'summary_large_image',
            'robots_index' => true,
            'robots_follow' => true,
            'robots_advanced' => null,
