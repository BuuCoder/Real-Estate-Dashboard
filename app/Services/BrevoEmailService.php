...
class BrevoEmailService
{
    ...
    {
        try {
            // Generate contact code once and reuse
            ...
            $emailData = [
                ...
                'subject' => 'Xác nhận đã nhận được yêu cầu liên hệ - Mã #' . $contactCode,
    ...
    private function getCleanPhoneForTel($phone)
    {
        // Remove any existing country code or special characters
        $cleanPhone = preg_replace('/[^0-9]/', '', $phone);
