    ...
    private function sendConfirmationEmailWithCC($contactData)
    {
        try {
            $emailData = [
                ...
                'subject' => 'Xác nhận đã nhận được yêu cầu liên hệ - #' . str_pad($contactData['contact_id'], 5, '0', STR_PAD_LEFT),
